...
$(function() {
	...
	// author badge :)
	var author = '<div style="position: fixed;bottom: 0;right: 20px;background-color: #fff;box-shadow: 0 4px 8px rgba(0,0,0,.05);border-radius: 3px 3px 0 0;font-size: 12px;padding: 5px 10px;font-weight: 400;">By <a href="https://instagram.com/_nomadicjosh_/" style="color: #ec7063;">@_nomadicjosh_</a> &nbsp;&bull;&nbsp; <a href="https://github.com/sponsors/nomadicjosh" style="color: #ec7063;">Sponsor Me</a></div>';
	$("body").append(author);
